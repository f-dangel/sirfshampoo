...
help:
	@echo "install"
	@echo "        Install sirfshampoo and dependencies"
	@echo "uninstall"
	@echo "        Uninstall sirfshampoo"
	@echo "lint"
	...
	@echo "conda-env"
	@echo "        Create conda environment 'sirfshampoo' with dev setup"
	@echo "darglint-check"
...
test:
	@pytest -vx --run-optional-tests=expensive --cov=sirfshampoo test

test-light:
	@pytest -vx --cov=sirfshampoo test
...
darglint-check:
	@darglint --verbosity 2 sirfshampoo test
